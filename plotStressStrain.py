...
knks_ratio_list = [3.0, 5.0, 7.0, 10.0]
#knks_ratio_list = [10.0]
...
for knks_ratio in knks_ratio_list:
    ...
    for confining_stress in confining_stress_list:
        ...
        #creat new folder
        aim_folder_name = 'Triaxial_Knks_ratio' + str(knks_ratio) + '_P' + str(confining_stress)
